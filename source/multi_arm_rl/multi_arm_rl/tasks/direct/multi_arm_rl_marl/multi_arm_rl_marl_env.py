...
from .multi_arm_rl_marl_env_cfg import MultiArmRlMarlEnvCfg


class MultiArmRlMarlEnv(DirectMARLEnv):
    cfg: MultiArmRlMarlEnvCfg

    def __init__(self, cfg: MultiArmRlMarlEnvCfg, render_mode: str | None = None, **kwargs):
